...
### Resposta:
    ...
    docker run --name mysql-dev -e MYSQL_ROOT_PASSWORD=docker_pwd -e MYSQL_USER=docker_usr -e MYSQL_PASSWORD=docker_pwd -e MYSQL_DATABASE=docker_db -p 3306:3306 -d mysql:latest
